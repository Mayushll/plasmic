...
import sty from "./PlasmicTask.module.css"; // plasmic-import: a4TRfTpZs29/css
...
function PlasmicTask__RenderFunc(props: {
  ...
  return (
    ...
    >
      <div
        className={classNames(projectcss.all, sty.freeBox__czgC6, {
          [sty.freeBoxstate_editing__czgC6Whz9X]: hasVariant(
            variants,
            "state",
            "editing"
          ),

          [sty.freeBoxstate_editing_global_theme_dark__czgC6Whz9XXO0Ou]:
            hasVariant(variants, "state", "editing") &&
            hasVariant(globalVariants, "theme", "dark")
        })}
      >
      ...
      <div
        className={classNames(projectcss.all, sty.freeBox__aNSs, {
          [sty.freeBoxglobal_theme_dark__aNSsxO0Ou]: hasVariant(
            globalVariants,
            "theme",
            "dark"
          ),

          [sty.freeBoxstate_editing__aNSsWhz9X]: hasVariant(
            variants,
            "state",
            "editing"
          ),

          [sty.freeBoxstate_editing_global_theme_dark__aNSsWhz9XXO0Ou]:
            hasVariant(variants, "state", "editing") &&
            hasVariant(globalVariants, "theme", "dark")
        })}
      >
        ...
        {(hasVariant(variants, "state", "editing") ? false : true) ? (
          <div
            className={classNames(projectcss.all, sty.freeBox___8NMzl, {
              [sty.freeBoxstate_editing___8NMzlWhz9X]: hasVariant(
                variants,
                "state",
                "editing"
              )
